...
public class HttpTools{
    ...
    //默认百度爬虫UA头
    private static String UA = "Mozilla/5.0 (compatible; Baiduspider/2.0; http://www.baidu.com/search/spider.html)";
    ...
    public static Response put(String url, String postString, HashMap<String,String> headers , String encoding){
        ...
        try {
            ...
            while(var5.hasNext()) {
                String key = (String)var5.next();
                coon.setRequestProperty(key, (String)headers.get(key));
            }
